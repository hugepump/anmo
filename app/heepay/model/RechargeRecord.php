...
{
    //定义表名
    protected $name = 'massage_heepay_recharge_record';
     ...
     */
    public function checkUserCash($user_id,$cash){
        ...
        $user_info = $heepay->userResInfo($heepay['apply_no']);
