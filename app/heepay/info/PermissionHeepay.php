 ...
 */
class PermissionHeepay extends PermissionAbstract {

    const tabbarKey = null;
    //后台管理菜单对应key[必填] , 当前模块文件夹名称
    const adminMenuKey = 'heepay';
    public $saasKey ;
    const apiPaths = [];
    ...
    public function __construct(int $uniacid,$infoConfigOptions=[],$saasKey='HEEPAY')
    {
    ...
    public function pAuth(): bool
    {
        ...
        $auth = \longbingcore\permissions\AdminMenu::getAuthList((int)$this->uniacid,['adapay']);
