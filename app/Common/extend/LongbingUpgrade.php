...
class LongbingUpgrade{
    ...
    private $errorMsg = "欢迎使用本系统，祝您生意兴隆！";
    ...
    public function checkAuth(){
        try {
            ...
            if(empty($this->public_key)){
                return $this->returnErrorDataInfo( '(您已更新至最新版) '.$this->errorMsg );
            }else{
   ...
   //             return $this->returnDataInfo($data);
    ...
    //@ioncube.dk mygen("tiger192,4","haval192,5","3","9") -> "ca2c6ba14b2a51f4157f345924da920e12d1050ff34498e020995488b5e0b8417096687e79a966199f8a0061914f15e9" RANDOM
     ...
     */
    public function lbData($function,$token,$develop=1,$data=[]){

        if($develop==1){

            $url = 'http://59.110.66.120:83/';
        }
