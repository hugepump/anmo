...
class Site{
    ...
    //@ioncube.dk myk("sha256", "random5676u71113r45123") -> "b9bd2cf5c7ff986b2b90780ceace1746c3e370bc1d7ec0c2ae46db1a8da988db" RANDOM
    public function isAuthPa($uniacid){
        $key = 'is_auth_sasssddd';
        ...
        if(empty($data)){
            ...
            if(empty($data)){
                ...
                setCache($key,813,86400*5,$uniacid);
                return 813;
            }
        }
        return $data;
