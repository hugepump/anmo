 ...
 */
class PermissionMap extends PermissionAbstract {

    const tabbarKey = null;
    //后台管理菜单对应key[必填] , 当前模块文件夹名称
    const adminMenuKey = 'map';
    public $saasKey ;
    const apiPaths = [];


    public function __construct($uniacid,$infoConfigOptions=[],$saasKey='MAP')
    {
