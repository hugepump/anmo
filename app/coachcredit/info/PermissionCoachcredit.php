...
namespace app\coachcredit\info;
 ...
 */
class PermissionCoachcredit extends PermissionAbstract {

    const tabbarKey = null;
    //后台管理菜单对应key[必填] , 当前模块文件夹名称
    const adminMenuKey = 'COACHCREDIT';
    public $saasKey ;
    const apiPaths = [];


    public function __construct($uniacid,$infoConfigOptions=[],$saasKey='COACHCREDIT')
    {
